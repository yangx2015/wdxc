...
public class ServerApiUtils {
    ...
    public boolean isOnline(String deviceId){
        try{
            String gpsurl =  CarApplication.getApplication().getServerUrlBase() + AppConsts.API_ONLINE + "/" + deviceId;
            RequestParams params = new RequestParams(gpsurl);
            params.setAsJsonContent(true);
            ...
            ApiResponse result = x.http().getSync(params, ApiResponse.class);
            I.e("ServiceAPI", " online result>>>>"+result.toString());

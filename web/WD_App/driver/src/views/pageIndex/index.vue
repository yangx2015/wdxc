...
<template>
	<div class="box">
		<div class="header">
			<div class="box-row">
				<div class="titLeft" @click="confirm()">
    ...
    filters:{
      ...
      strT(val){
        ...
        listType:0,
				titFind:'',
        actions:[
          {name:'修改密码',method:this.gopassword},
          {name:'退出登录',method:this.backlogin},
        ],
			}
		},
		created(){
        ...
        this.$http.post('/put/jzg/getInfo',{}).then((res)=>{
          localStorage.setItem("userinfo",res.result.userInfo);
          if(res.result.userinfo.sjhm == ''){
              this.$route.push({name:'phonenum'})
            }
          })
        },
        confirm () {

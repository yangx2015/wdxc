<template>
      <div class="modal">
        ...
        <div>
          <Row><Col align="center" style="padding: 10px 20px;color: #e77a13;font-size: 24px;font-weight: 700">
            合计: {{moneyAdd}}元
          </Col></Row>
        </div>
...
<script>
    ...
    export default {
      ...
      watch:{
        "formValidate.lc":function (n,o) {
          this.getInputVal()
        },
        "formValidate.dj":function (n,o) {
          this.getInputVal()
        },
        "formValidate.gqf":function (n,o) {
          this.getInputVal()
        },
        "formValidate.glf":function (n,o) {
          this.getInputVal()
        },
      ...
      created(){
        ...
        methods: {
          getInputVal(){
            ...
            let gqf = '0';
            let glf = '0';
            if(this.formValidate.lc == ''){
              lc='0'
            }else{
              lc = this.formValidate.lc
            }
            if(this.formValidate.dj == ''){
              dj='0'
            }else{
              dj = this.formValidate.dj
            }
            if(this.formValidate.gqf == ''){
              gqf='0'
            }else{
              gqf = this.formValidate.gqf
            }
            if(this.formValidate.glf == ''){
              glf='0'
            }else{
              glf = this.formValidate.glf
            }

...
<script>
    ...
    export default {
        ...
        methods:{
            getDfp(){
                var v = this
                this.$http.post(this.apis.ORDER.DFP,{'cllx':10,'zkl':this.mess.zkl}).then((res) =>{
                    if(res.code ==200){
                        v.data1 = res.result
            ...
            addlist(listID){
                var v = this
                this.$http.post(this.apis.ORDER.FP,{'sjSx':10,'sj':this.mess.sfzhm,'id':listID,'cph':''}).then((res) =>{
                    if(res.code===200){

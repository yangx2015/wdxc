...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  config: {
    "pages": ["pages/index", "pages/detail", "pages/xlMess", "pages/xlMap", "pages/welcome", "pages/common/busline", "pages/prop/add", "pages/prop/pages"],
    "theme": {
      "theme-color": "#3399ff"
    },
    "window": {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(96);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__ = __webpack_require__(98);
...
config.routes = [{
  ...
  component: function component(resolve) {
    __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(177)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  },
  meta: {
    pageConfig: {
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 179));
  }
}, {
  path: '/pages/xlMess',
  meta: { pageConfig: {
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 181));
  }
}, {
  path: '/pages/welcome',
  meta: { pageConfig: {
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(8).then(__webpack_require__.bind(null, 183));
  }
}, {
  path: '/pages/prop/add',
  meta: { pageConfig: {

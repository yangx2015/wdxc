...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_ui__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__static_css_box_less__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__static_css_color_less__ = __webpack_require__(178);
...
__WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__["a" /* default */].networkBaseUrl = 'http://10.113.4.71:9090/biz';
...
__WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__["a" /* default */].extend({
  ...
  getWxJs: function getWxJs() {
    ...
    script.onload = function () {
      ...
      // 微信js初始化成功后引用 微信功能方法
      __WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__["a" /* default */].getApp().wxUtil = __webpack_require__(179).default;
  ...
  $http: function $http(method, url, data, callback) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_touchui_dist_ui__["a" /* default */].request({
      ...
      success: function success(res) {
        console.log('请求成功');
        if (res.data.code == 999 || res.data.code == 403) {
...
config.routes = [{
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(8).then(__webpack_require__.bind(null, 187));
  }
}, {
  path: '/pages/detail',
  meta: { pageConfig: {
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 194));
  }
}, {
  ...
  meta: { pageConfig: {
      ...
      navigationBarTextStyle: 'white'
    }, pageClass: 'page-7f026f', isTabBar: false },
  component: function component() {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 196));
  }
}, {
  path: '/pages/orders',
  meta: { pageConfig: {
      disableScroll: true
    }, pageClass: 'page-a99d61', isTabBar: false },
  component: function component() {
  ...
  meta: { pageConfig: {
    ...
    }, pageClass: 'page-55ac65', isTabBar: false },
  component: function component() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_touchui_dist_components_tab_bar__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_touchui_dist_components_text__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_touchui_dist_components_slide_menu__ = __webpack_require__(174);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  config: {
    "pages": ["pages/index", "pages/login", "pages/detail", "pages/user", "pages/xlMess", "pages/xlMap", "pages/welcome", "pages/common/busline", "pages/prop/add", "pages/prop/pages", "pages/mark", "pages/orders", "pages/others"],
    "theme": {
      "theme-color": "#3399ff"
    },
    "window": {
    ...
    "networkBaseUrl": 'http://10.113.4.71:9090/biz',
    "networkTimeout": "3000"
  },
  data: function data() {
    return {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "oures ui-row ui-row-border-top ui-row-border-bottom",
    style: ({
      'margin-top': '1px',
      'margin-bottom': '1px'
    })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(104);

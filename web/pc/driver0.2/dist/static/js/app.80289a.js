...
config.routes = [{
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 182));
  }
}, {
  path: '/',
  ...
  component: function component() {
    return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 183));
  }
}, {
  path: '/pages/detail',
  meta: { pageConfig: {

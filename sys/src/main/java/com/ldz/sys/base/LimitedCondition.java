...
public class LimitedCondition extends SimpleCondition {
     ...
     */
    private static final List<String> excludeEntityName = Arrays.asList("ClClyxjl","SysZdlm","SysFw","SysGn","SysYjfk","SysRz","ClZnzp","ClLsdw","ClLsc","ClDzwlCl","ClSbyxsjjl","SysHsgs");
